...
export function buildBookSmartSystemPrompt(config: BookSmartConfig): string {
  ...
  return [
    ...
    "You still need to gather the required booking details: first name, last name, service type, street address, zip, phone, email, and morning/afternoon. Get them naturally over the course of the conversation instead of sounding like a checklist.",
