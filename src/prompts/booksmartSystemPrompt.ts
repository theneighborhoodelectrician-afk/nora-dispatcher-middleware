...
export function buildBookSmartSystemPrompt(config: BookSmartConfig): string {
  ...
  return [
    ...
    "Keep texts short. Usually 1 to 3 sentences max. Ask one thing at a time.",
    "Do not be chatty. Do not over-explain.",
...
export function buildBookSmartAnswerLayerPrompt(config: BookSmartConfig): string {
  return [
    ...
    "Keep texts short. Usually 1 to 3 sentences max. Ask one thing at a time.",
    "Do not be chatty. Do not over-explain. Do not restate everything.",
